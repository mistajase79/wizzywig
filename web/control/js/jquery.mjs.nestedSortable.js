 ...
 *
 * ************************************************
 * PCGC - this has been updated for the PROTOCMSv2
 * PCGC - Add/change any custom vars goto line 767
 * ************************************************
 *
 * Depends on:
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		toArray: function(options) {
			...
			function _recursiveArray(item, depth, _left) {
				...
				var navtitle = $(item).find('input.form-navtitle').val();
				var slug = $(item).find('input.form-slug').val();
