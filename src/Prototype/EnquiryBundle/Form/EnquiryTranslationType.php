...
namespace Prototype\EnquiryBundle\Form;
...
class EnquiryTranslationType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if($options['localsAndAttributesArray'] != null){
            ...
            $builder->add('translatableLocale', null, array('mapped' => false, 'attr'=>array('readonly'=>'readonly', 'value' =>$options['currentLocale'])));
        }
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Prototype\EnquiryBundle\Entity\Enquiry',
