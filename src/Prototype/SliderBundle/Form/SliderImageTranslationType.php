...
namespace Prototype\SliderBundle\Form;
...
class SliderImageTranslationType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('image', imagemanagerType, array('image_path' => 'filePath'))
            ->add('html', redactorType)
            ->add('link', textType, array('required' => false))
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Prototype\SliderBundle\Entity\SliderImages',
