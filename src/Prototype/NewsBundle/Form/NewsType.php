...
namespace Prototype\NewsBundle\Form;
...
class NewsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            //->add('thumbnail')
            ->add('article', redactorType, array('label' => 'Article Content'))
            ->add('exert', redactorType, array('label' => 'Exert'))
            ->add('publishDate', datepickerType)
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Prototype\NewsBundle\Entity\News'
        ));
    }
}
