...
class Menu
{
  ...
  */
    ...
    {
        $this->menu_items = new \Doctrine\Common\Collections\ArrayCollection();
    }

    /**
     * Add menu_items
     *
     * @param \Prototype\MenuBundle\Entity\MenuItems $menuItems
     * @return Menu
     */
    public function addMenuItem(\Prototype\MenuBundle\Entity\MenuItems $menuItems)
    {
        $this->menu_items[] = $menuItems;
     ...
     * @param \Prototype\MenuBundle\Entity\MenuItems $menuItems
     */
    public function removeMenuItem(\Prototype\MenuBundle\Entity\MenuItems $menuItems)
    {
