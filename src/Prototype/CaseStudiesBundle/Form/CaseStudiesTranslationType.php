...
namespace Prototype\CaseStudiesBundle\Form;
...
class CaseStudiesTranslationType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Prototype\CaseStudiesBundle\Entity\CaseStudies',
