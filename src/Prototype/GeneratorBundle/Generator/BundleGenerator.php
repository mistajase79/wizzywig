...
class BundleGenerator extends Generator
{
    ...
    public function generateBundle(Bundle $bundle)
    {
        ...
        $replacements = array("bundle", "prototype", "Bundle", "Prototype", "/", "\\");
        $shortname = str_replace($replacements, "", $bundle->getNamespace());
        ...
        $this->renderFile('bundle/index.html.twig.twig', $dir.'/../../../app/Resources/views/base/'.strtolower($shortname).'/'.strtolower($shortname).'.html.twig', $parameters);

        // render entity$shortname
        $this->renderFile('bundle/Entity.php.twig', $dir.'/Entity/'.$shortname.'.php', $parameters);
        $this->renderFile('bundle/translationsEntity.php.twig', $dir.'/Entity/'.$shortname.'Translations.php', $parameters);
        $this->renderFile('bundle/repository.php.twig', $dir.'/Repository/'.$shortname.'Repository.php', $parameters);
