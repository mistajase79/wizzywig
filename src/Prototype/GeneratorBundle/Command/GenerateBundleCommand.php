...
use Prototype\GeneratorBundle\Generator\BundleGenerator;
 ...
 */
class GenerateBundleCommand extends \Sensio\Bundle\GeneratorBundle\Command\GeneratorCommand
{
    /**
     * @see Command
     */
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOT
*** CUSTOM PROTOTYPE BUNDLE GENERATOR ***
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // $output->writeln($dir.'/../../../app/Resources/views/base/'.strtolower($shortname).'/'.strtolower($shortname).'.html.twig');
    ...
    {
        $questionHelper = $this->getQuestionHelper();
        $questionHelper->writeSection($output, 'Welcome to the PROTOCMSv2 bundle generator!');
